...
/**
 * Our implementaion of the UserDetailsService that the security framework
 * expects.
 */
@Service
public class SecurityService implements UserDetailsService {
	...
	/**
	 *
	 * NOTE: this method is not checking the password, but it does return the
	 * encoded password that the security framework can use to check the password
	 * against
	 *
