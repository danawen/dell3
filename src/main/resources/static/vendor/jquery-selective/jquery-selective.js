  ...
  function(_jquery) {
    ...
    var DEFAULTS = {
      ...
      tpl: {
        ...
        option: function option(content) {
          return (
            '<option value="' +
            this.options.tpl.optionValue.call(this) +
            '">' +
            content +
            '</option>'
          );
        ...
        listItem: function listItem(content) {
          return (
            '<li class="' + this.namespace + '-list-item">' + content + '</li>'
          );
        }
      },
      ...
      _createClass(Options, [
        ...
        },
        {
          ...
          value: function add(data) {
            ...
            if (
              this.instance.options.buildFromHtml === false &&
              this.instance.getItem(
                'option',
                this.instance.$select,
                this.instance.options.tpl.optionValue(data)
              ) === undefined
            ) {
              var $option = $(
                this.instance.options.tpl.option.call(this.instance, data)
              );
            ...
            if (this.instance.options.buildFromHtml === true) {
              if ($options.length !== 0) {
                $.each(
                  ...
                  function(i, n) {
                    var $li = $(
                      _this.instance.options.tpl.listItem.call(
                        _this.instance,
                        n.text
                      )
                    );
              ...
              if ($options.length !== 0) {
                $.each(
                  ...
                  function(i, n) {
                    var $n = $(n);
                    var li = _this.instance.getItem(
                      'li',
                      $list,
                      _this.instance.options.tpl.optionValue(
                        $n.data('selective_index')
                      )
                    );
        ...
        },
        {
          ...
          value: function buildSearch() {
            if (this.instance.options.withSearch === true) {
              this.instance.$triggerDropdown.prepend(
                this.instance.options.tpl.search.call(this.instance)
              );
              this.instance.$search = this.instance.$triggerDropdown.find(
                '.' + this.instance.namespace + '-search'
              );
            }
          ...
          value: function filter(val) {
            $.expr[':'].Contains = function(a, i, m) {
              return jQuery(a)
                .text()
                .toUpperCase()
                .includes(m[3].toUpperCase());
            };

            if (val) {
              this.instance.$list
                .find('li:not(:Contains(' + val + '))')
                .slideUp();
            ...
            this.instance.$listWrap.on(
              ...
              function() {
                if (pageMax > _this2.instance.page) {
                  ...
                  if (below === 0) {
                    _this2.instance.options.query(
                      _this2.instance,
                      _this2.instance.$search.val(),
                      ++_this2.instance.page
                    );
                  }
                }
              }
          ...
          value: function change() {
            ...
            this.instance.$search.change(function() {
              ...
              if (_this3.instance.options.buildFromHtml === true) {
                ...
                _this3.instance.options.query(
                  _this3.instance,
                  _this3.instance.$search.val(),
                  _this3.instance.page
                );
              } else {
                ...
                if (_this4.instance.options.buildFromHtml === true) {
                  ...
                  timeout = window.setTimeout(function() {
                    if (currentValue !== '') {
                      ...
                      _this4.instance.options.query(
                        _this4.instance,
                        currentValue,
                        _this4.instance.page
                      );
                    } else {
    ...
    var Items = (function() {
      ...
      _createClass(Items, [
            ...
            if (data !== null) {
              $.each(
                ...
                function(i) {
                  ...
                  _this5.instance._options.select(
                    _this5.instance.getItem(
                      'option',
                      _this5.instance.$select,
                      _this5.instance.options.tpl.optionValue(data[i])
                    )
                  );
        ...
        },
        {
          ...
          value: function remove(obj) {
            ...
            if (this.instance.options.buildFromHtml === true) {
              ...
              this.instance._options.unselect(
                obj.data('selective_index').data('selective_index')
              );
            } else {
              $li = this.instance.getItem(
                'li',
                this.instance.$list,
                this.instance.options.tpl.optionValue(
                  obj.data('selective_index')
                )
              );
        ...
        },
        {
          ...
          value: function click() {
            var that = this;
            this.instance.$items.on(
              'click',
              '.' + this.instance.namespace + '-remove',
    ...
    var Selective = (function() {
      function Selective(element) {
        ...
        this.$select =
          this.$element.is('select') === true ? this.$element : _build();
        ...
        [
          {
            ...
            value: function init() {
              ...
              this.$items = this.$selective.find(
                '.' + this.namespace + '-items'
              );
              this.$trigger = this.$selective.find(
                '.' + this.namespace + '-trigger'
              );
              this.$triggerButton = this.$selective.find(
                '.' + this.namespace + '-trigger-button'
              );
              this.$triggerDropdown = this.$selective.find(
                '.' + this.namespace + '-trigger-dropdown'
              );
              this.$listWrap = this.$selective.find(
                '.' + this.namespace + '-list-wrap'
              );
              ...
              (0, _jquery2.default)(document).on(
                ...
                function(e) {
                  if (_this8.options.closeOnSelect === true) {
                    if (
                      (0, _jquery2.default)(e.target).closest(
                        _this8.$triggerButton
                      ).length === 0 &&
                      (0, _jquery2.default)(e.target).closest(_this8.$search)
                        .length === 0
                    ) {
                      _this8._hide();
                    }
                  } else if (
                    (0, _jquery2.default)(e.target).closest(_this8.$trigger)
                      .length === 0
                  ) {
                    _this8._hide();
                  }
              ...
              if (this.options.buildFromHtml === true) {
                ...
                this._options.select(
                  this.getItem(
                    'option',
                    this.$select,
                    this.options.tpl.optionValue(data)
                  )
                );
                this.itemAdd(data);
              }
          ...
          },
          {
            ...
            value: function getItem(type, $list, index) {
              ...
              for (var i = 0; i < $items.length; i++) {
                if (
                  this.options.tpl.optionValue(
                    $items.eq(i).data('selective_index')
                  ) === index
                ) {
                  position = i;
                }
          ...
          },
          {
            ...
            value: function itemAdd(data, content) {
              ...
              this._items.instance.selected = [];
              $('ul.addMember-items li.addMember-item').remove();
