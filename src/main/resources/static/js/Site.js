(function(global, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    factory(
      ...
      global.Config,
      global.Base,
      global.SectionMenubar,
      global.SectionGridMenu,
      global.SectionSidebar,
      global.SectionPageAside
    );
    ...
    (function(_Base) {
      ...
      function Site() {
        ...
        return babelHelpers.possibleConstructorReturn(
          this,
          babelHelpers.getPrototypeOf(Site).apply(this, arguments)
        );
      }
      ...
      babelHelpers.createClass(Site, [
              ...
              if (screenfull.enabled) {
                DOC.addEventListener(
                  ...
                  function() {
                    ...
                    ).toggleClass('active', screenfull.isFullscreen);
                  }
                );
              }
            }
        ...
        },
        {
          ...
          value: function setupMegaNavbar() {
            $DOC
              .on('click', '.navbar-mega .dropdown-menu', function(e) {
                e.stopPropagation();
              })
              .on('show.bs.dropdown', function(e) {
                var $target = (0, _jquery.default)(e.target);
                var $trigger = e.relatedTarget
                  ? (0, _jquery.default)(e.relatedTarget)
                ...
                if (animation) {
                  ...
                  $menu
                    .addClass('animation-'.concat(animation))
                    .one(
              ...
              .on('shown.bs.dropdown', function(e) {
                var $menu = (0, _jquery.default)(e.target).find(
        ...
        },
        {
          ...
          value: function setupTour(flag) {
            if (typeof this.tour === 'undefined') {
              ...
              (0, _jquery.default)('.site-tour-trigger').on(
                'click',
                function() {
                  self.tour.start();
                }
        ...
        },
        {
          ...
          value: function setupWave() {
            if (typeof Waves !== 'undefined') {
              ...
              Waves.attach('.site-navbar .navbar-toolbar a', [
                'waves-light',
                'waves-round'
              ]);
