(function(global, factory) {
  ...
  var Stage =
    ...
    (function() {
      function Stage(data) {
        ...
        this.taskList = null;
        this.render();
        this.$stageDropdownArrow = $(
          '.taskboard-stage-actions a[data-toggle="dropdown"]',
          this.$el
        );
  ...
  var sildePaneldefaultsOptions = {
    ...
    afterLoad: function afterLoad(object) {
      ...
      this.$panel
        .find('.'.concat(this.options.classes.base, '-scrollable'))
        .asScrollable({
    ...
    contentFilter: function contentFilter(data, object) {
      ...
      slidePanel.handleSelective(
        $('[data-plugin="jquery-selective"]', $panel),
        info.members
      );
      ...
      if (info.comments.length !== 0) {
        ...
        for (var _i2 = 0; _i2 < _length2; _i2++) {
          var $comment = $(
            slidePanel.commentTpl(
              info.comments[_i2].src,
              info.comments[_i2].user,
              info.comments[_i2].time,
              info.comments[_i2].content
            )
          );
  ...
  var slidePanel = {
      ...
      $target.selective({
        ...
        tpl: {
          ...
          listItem: function listItem(data) {
            return '<li class="'
              .concat(this.namespace, '-list-item"><img class="avatar" src="')
              .concat(data.img, '">')
              .concat(data.name, '</li>');
          },
          item: function item(data) {
            return '<li class="'
              .concat(this.namespace, '-item"><img class="avatar" src="')
              .concat(data.img, '">\n            ')
              .concat(
        ...
        onAfterItemAdd: function onAfterItemAdd() {
          var $target = this.$element.closest('.slidePanel').data('slidePanel')
            .target;
    ...
    handlePriority: function handlePriority() {
      $(document).on('click', '[name="priorities"]', function() {
        ...
        $target
          ...
          .addClass('priority-'.concat($target.data('taskInfo').priority));
      });
    },
    ...
    handleEditor: function handleEditor() {
      ...
      $(document).on('click', '.task-main-editor-save', function() {
        ...
        $('.slidePanel .description-content').html(
          $target.data('taskInfo').description
        );
        $this
          .closest('.slidePanel')
          .find('.task-main')
    ...
    handleSubtasks: function handleSubtasks() {
      ...
      $(document).on('click', '.subtask-editor-save', function() {
        ...
        $target.data('taskInfo', taskData);
        $('.title', $('.subtasks-list .subtask')[index]).html(
          $('.subtask-title', $subtask).val()
        );
        $subtask.removeClass('is-edit');
        $(document).off('click.subtask');
      });
        ...
        bootbox.dialog({
          ...
          buttons: {
            success: {
              ...
              callback: function callback() {
                var $subtask = $this.closest('.subtask');
                var $target = $this.closest('.slidePanel').data('slidePanel')
                  .target;
                var data = $target.data('taskInfo');
                var index = $subtask.index();
                var taskData = $target.data('taskInfo');
        ...
        },
        {
          ...
          value: function getTpl(data) {
            ...
            return '\n            <li class="list-group-item priority-'
              .concat(
                data.priority,
                '" data-taskboard="slidePanel" data-url="panel.tpl">\n              <div class="checkbox-custom checkbox-primary">\n                <input type="checkbox" '
              )
              .concat(
                checkedString,
      ...
      babelHelpers.createClass(Duedate, [
        ...
        },
        {
          ...
          value: function getTpl(content) {
            return '<span class="task-badge task-badge-subtask icon md-calendar">'.concat(
              content,
              '</span>'
            );
          }
    ...
    (function() {
      ...
      babelHelpers.createClass(Subtask, [
        ...
        },
        {
          key: 'getTpl',
          value: function getTpl(content) {
            return '<span class="task-badge task-badge-subtask icon md-format-list-bulleted">'.concat(
              content,
              '</span>'
            );
          }
    ...
    (function() {
      ...
      babelHelpers.createClass(Attachment, [
        ...
        },
        {
          key: 'getTpl',
          value: function getTpl(content) {
            return '<span class="task-badge task-badge-attachments icon md-attachment-alt">'.concat(
              content,
              '</span>'
            );
          }
    ...
    (function() {
      ...
      babelHelpers.createClass(Comment, [
        ...
        },
        {
          key: 'getTpl',
          value: function getTpl(content) {
            return '<span class="task-badge task-badge-comments icon md-comment">'.concat(
              content,
              '</span>'
            );
          }
      ...
      babelHelpers.createClass(Member, [
        ...
        },
        {
          ...
          value: function getTpl(src) {
            return '<li><img class="avatar avatar-sm" src="'.concat(
              src,
              '"></li>'
            );
          }
    ...
    (function(_Site) {
      ...
      function AppTaskboard() {
        ...
        return babelHelpers.possibleConstructorReturn(
          this,
          babelHelpers.getPrototypeOf(AppTaskboard).apply(this, arguments)
        );
      }
      ...
      babelHelpers.createClass(AppTaskboard, [
        {
          ...
          value: function initialize() {
            babelHelpers
              .get(
                babelHelpers.getPrototypeOf(AppTaskboard.prototype),
                'initialize',
                this
              )
              .call(this);
        ...
        },
        {
          ...
          value: function createStageList() {
            ...
            $.getJSON(''.concat(assets, '/data/taskboard.json'), function(
              data
            ) {
        ...
        },
        {
          ...
          value: function bindFloatBtn() {
            ...
            this.$floatBtn.on('click', function() {
              ...
              $('option:first', $('select', _this6.$model)).prop(
                'selected',
                'selected'
              );
            });
